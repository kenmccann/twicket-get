...
parser.add_argument('-m', '--min-tickets', help='Minimum amount of tickets for which a purchase should be attempted', required=False, default=2)
parser.add_argument('-M', '--max-tickets', help='Maximum amount of tickets for which a purchase should be attempted', required=False, default=4)
