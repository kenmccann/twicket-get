...
parser.add_argument('-t', '--time-delay', help='Time delay for availability polling (in seconds), default: 2s', type=float, required=False, default=2)
...
parser.add_argument('-m', '--min-tickets', help='Minimum amount of tickets for which a purchase should be attempted', required=False, type=int, default=2)
parser.add_argument('-M', '--max-tickets', help='Maximum amount of tickets for which a purchase should be attempted', required=False, type=int, default=4)
...
def get_ticket_avail(inventory_id, seats):
    ...
    if response.status_code == 200:
        ...
        logging.error("\nTicket Avail – Statuscode not 200")
        try:
            ...
            if options:
                ...
                while len(options) > 0:
                    ...
                    if ticket.get('available') and int(current['seats']) >= args.min_tickets and int(current['seats']) <= args.max_tickets:
                        ...
                        if hold_details:
                            logging.info("Hold details: " + hold_details['holdReference'] + ": expires " + hold_details['expires'])
